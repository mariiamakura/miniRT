...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023-10-12 14:50:54 by lbaron            :+:    #+#             */
/*   Updated: 2023-10-12 14:50:54 by lbaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//IntersectRay.c
int				intersect_ray_sp(t_int param, t_sphere *sp,
					float *t1, float *t2);
int				intersect_ray_pl(t_int param, t_plane *pl, float *t);
int				in_one_cap_cy(t_int param, t_cylinder *cy,
					t_plane *pl, float *t);
float			ft_distance(t_xyz *vec1, t_xyz *vec2);
t_xyz			reveal_intersectionpoint_xyz(t_int param, float t);

//IntersectRay2.c
int				intersect_ray_caps_cy(t_int param,
					t_cylinder *cylinder, float *t);
int				intersect_ray_side(t_int param,
					t_cylinder *cylinder, float *t1);
int				intersect_ray_cy(t_int param, t_cylinder *cy, float *t);

//ClosestIntersection.c
float			closest_inter(t_rt **rt, t_int param, t_objects **closest_obj);
