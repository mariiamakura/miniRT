...
//    printf("test3_6\n"); test((t_xyz){1.0, 0.0, 0.0}, (t_xyz){-1.0, 0.0, 0.0});
//
    printf("test4_1\n"); test((t_xyz){0.0, 0.0, 1.0}, (t_xyz){0.0, 1.0, 1.0});
    printf("test4_2\n"); test((t_xyz){0.0, 0.0, 1.0}, (t_xyz){1.0, 1.0, 0.0});
    printf("test4_3\n"); test((t_xyz){0.0, 0.0, 1.0}, (t_xyz){1.0, 0.0, 1.0});
    printf("test4_4\n"); test((t_xyz){0.0, 0.0, 1.0}, (t_xyz){1.0, 1.0, 1.0});
}
